...
public enum EnemyTypes {
    ...
    ELITE_HUNTER(150,270,15,12,190,120,15,10),
    FAUSTINOMON(400,500,19,30,200,180,20,10),
    SERINGASMON(450,400,17,25,180,130,20,10),
    MARIANAMON(390,450,22,10,120,190,30,10);
